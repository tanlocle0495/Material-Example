...
package com.example.loc.lybrarymenu.animation.View;
...
import com.example.loc.lybrarymenu.R;
import com.example.loc.lybrarymenu.animation.Adapter.AbsDateAdapter;
...
import com.example.loc.lybrarymenu.animation.PaperDatepicker;
    ...
    private void setDates(TypedArray typedArray) {
        ...
        try {
            if (defaultDaySelection != null && !defaultDaySelection.isEmpty()) {
                defaultDate = PaperDatepicker.DD_MM_YYY_FORMAT.parse(defaultDaySelection);
            }
        ...
        try {
            Date start = PaperDatepicker.DD_MM_YYY_FORMAT.parse(dateStart);
            Date end = PaperDatepicker.DD_MM_YYY_FORMAT.parse(dateEnd);
